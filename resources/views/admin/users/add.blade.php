...
<section class="content">
    <div class="row">
        <div class="col-md-6">
            ...
            <form method="post" action="{{ route('adduser') }}" id="add-user" enctype="multipart/form-data">
            @csrf
                ...
                <!-- form start -->
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="phone" placeholder="Enter Phone" value="{{ old('phone') }}" required>
                        </div>
